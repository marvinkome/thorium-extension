<?php
class Thorium_Ext_Widget_Services extends WP_Widget {

    /**
    * Register widget with WordPress.
    */
    function __construct() {
        parent::__construct( 'thorium_ext_services', __( 'Thorium - Services', 'thorium-ext' ), array( 'description' => __( 'Add this widget in "Front page - Servicess Sidebar".', 'thorium-ext' ), ) );
    ...
    */
    public function widget( $args, $instance ) {
        ...
        $output .= '<span class="fa-stack fa-4x">';
            $output .= '<i class="fa fa-circle fa-stack-2x text-primary"></i>';
            $output .= '<i class="fa '.$icon.' fa-stack-1x fa-inverse"></i>';
         $output .= '</span>';
         $output .= '<h4 class="services-heading">'. $title .'</h4>' ;
    ...
    */
    public function form( $instance ) {
        ...
        $title = ! empty( $instance['title'] ) ? sanitize_text_field( $instance['title'] ) : __( 'Thorium - Servicess', 'thorium-ext' );
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'icon' ); ?>"><?php _e( 'Icon:', 'thorium-ext' ); ?></label>
            <select class="widefat" id="<?php echo $this->get_field_id( 'icon' ); ?>" name="<?php echo $this->get_field_name( 'icon' ); ?>">
                <option value="all-font-awesome-icons"><?php _e( 'All Font Awesome Icons', 'thorium-ext' ); ?></option>
...
add_action( 'widgets_init', 'thorium_ext_register_widget_services' );

function thorium_ext_register_widget_services () {
    register_widget( 'Thorium_Ext_Widget_Services' );
}